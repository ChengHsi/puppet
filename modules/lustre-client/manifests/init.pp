class lustre-client {
    ...
    package {"kernel-firmware":
              ...
              #source  => 'puppet:///modules/lustre-client/kernel-firmware-2.6.32-431.1.2.el6.noarch.rpm',
              #source  => "ftp://mirror.switch.ch/pool/1/mirror/scientificlinux/6.3/x86_64/updates/security/kernel-firmware-2.6.32-358.18.1.el6.noarch.rpm",
              alias   => kernel-firmware,
              before  => Package[kernel],
              #provider=> rpm
            }
    package {"kernel-2.6.32-358.18.1.el6":
              #ensure  => present,
              ensure  => '2.6.32-358.18.1.el6',
              #source  => 'puppet:///modules/lustre-client/',
	      source  => "ftp://mirror.switch.ch/pool/1/mirror/scientificlinux/6.4/x86_64/updates/security/kernel-2.6.32-358.18.1.el6.x86_64.rpm",
              alias   => kernel,
              before  => Package[lustre-module],
              provider=> rpm
            }
    package {"kernel-2.6.32-358.el6":
              ensure  => present,
              #source  => 'puppet:///modules/lustre-client/kernel-2.6.32-358.el6.x86_64.rpm',
              source  => "ftp://mirror.switch.ch/pool/1/mirror/scientificlinux/6.4/x86_64/os/Packages/kernel-2.6.32-358.el6.x86_64.rpm",
              alias   => old_kernel,
